...
class Usuario extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	const SQL_INSERT='INSERT INTO `usuario` (`id`,`nome`,`senha`,`imagem`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `usuario` (`nome`,`senha`,`imagem`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `usuario` SET `id`=?,`nome`=?,`senha`=?,`imagem`=? WHERE `id`=?';
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_SENHA=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,225,0,false),
